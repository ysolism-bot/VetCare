...
//#region src/effect-schema/schema.types.d.ts
interface CreateSelectSchema {
  ...
  <TEnum extends PgEnum<any> | CockroachEnum<any>>(enum_: TEnum): Literals<Readonly<TEnum['enumValues']> extends infer R extends readonly LiteralValue[] ? R : TEnum['enumValues']>;
}
