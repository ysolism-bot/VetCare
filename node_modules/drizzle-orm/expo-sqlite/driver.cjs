...
var ExpoSQLiteDatabase = class extends __sqlite_core_db_ts.BaseSQLiteDatabase {
	static [__entity_ts.entityKind] = "ExpoSQLiteDatabase";
};
function drizzle(client, config = {}) {
	...
	const db = new ExpoSQLiteDatabase("sync", dialect, new require_expo_sqlite_session.ExpoSQLiteSession(client, dialect, relations, schema, {
		logger,
...
//#endregion
exports.ExpoSQLiteDatabase = ExpoSQLiteDatabase;
