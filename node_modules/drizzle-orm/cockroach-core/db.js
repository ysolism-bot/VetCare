import { CockroachCountBuilder } from "./query-builders/count.js";
import { RelationalQueryBuilder } from "./query-builders/query.js";
import { CockroachRaw } from "./query-builders/raw.js";
import { CockroachRefreshMaterializedView } from "./query-builders/refresh-materialized-view.js";
import { entityKind } from "../entity.js";
import { WithSubquery } from "../subquery.js";
import { sql } from "../sql/sql.js";
import { SelectionProxyHandler } from "../selection-proxy.js";
import { CockroachDeleteBase, CockroachInsertBuilder, CockroachSelectBuilder, CockroachUpdateBuilder, QueryBuilder } from "./query-builders/index.js";

//#region src/cockroach-core/db.ts
var CockroachDatabase = class {
	static [entityKind] = "CockroachDatabase";
	_query;
	constructor(dialect, session, schema) {
		...
		this._query = {};
		if (this._.schema) for (const [tableName, columns] of Object.entries(this._.schema)) this._query[tableName] = new RelationalQueryBuilder(schema.fullSchema, this._.schema, this._.tableNamesMap, schema.fullSchema[tableName], columns, dialect, session);
	}
	/**
	...
	*/
	...
	$count(source, filters) {
		return new CockroachCountBuilder({
			source,
			filters,
	...
	*/
	...
	execute(query) {
		...
		return new CockroachRaw(() => prepared.execute(void 0, this.authToken), sequel, builtQuery, (result) => prepared.mapResult(result, true));
	}
...
//#endregion
export { CockroachDatabase, withReplicas };
