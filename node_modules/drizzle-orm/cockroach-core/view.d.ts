...
interface CockroachMaterializedViewFn {
  <TName extends string>(name: TName): MaterializedViewBuilder<TName>;
  <TName extends string, TColumns extends Record<string, ColumnBuilderBase>>(name: TName, columns: TColumns): ManualMaterializedViewBuilder<TName, TColumns>;
}
declare function cockroachViewWithCasing(casing: Casing | undefined): CockroachViewFn;
declare const cockroachView: CockroachViewFn;
declare const cockroachMaterializedView: CockroachMaterializedViewFn;
...
//#endregion
export { CockroachMaterializedView, CockroachMaterializedViewConfig, CockroachMaterializedViewFn, CockroachMaterializedViewWithSelection, CockroachView, CockroachViewFn, CockroachViewWithSelection, DefaultViewBuilderCore, ManualMaterializedViewBuilder, ManualViewBuilder, MaterializedViewBuilder, MaterializedViewBuilderCore, ViewBuilder, cockroachMaterializedView, cockroachView, cockroachViewWithCasing, isCockroachMaterializedView, isCockroachView };
