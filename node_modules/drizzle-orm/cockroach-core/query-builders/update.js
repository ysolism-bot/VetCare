...
var CockroachUpdateBuilder = class {
	static [entityKind] = "CockroachUpdateBuilder";
	...
	set(values) {
		return new CockroachUpdateBase(this.table, mapUpdateSet(this.table, values), this.session, this.dialect, this.withList);
	}
};
var CockroachUpdateBase = class extends QueryPromise {
	static [entityKind] = "CockroachUpdate";
	config;
	tableName;
	joinsNotNullableMap;
	...
	getTableLikeFields(table) {
		if (is(table, CockroachTable)) return table[Table.Symbol.Columns];
...
//#endregion
export { CockroachUpdateBase, CockroachUpdateBuilder };
