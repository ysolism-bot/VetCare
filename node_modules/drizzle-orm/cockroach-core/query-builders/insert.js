...
var CockroachInsertBuilder = class {
	static [entityKind] = "CockroachInsertBuilder";
...
var CockroachInsertBase = class extends QueryPromise {
	static [entityKind] = "CockroachInsert";
	config;
	...
	*/
	...
	_prepare(name, generateName = false) {
		return tracer.startActiveSpan("drizzle.prepareQuery", () => {
			...
			return this.session.prepareQuery(query, this.config.returning, name ?? (generateName ? preparedStatementName(query.sql, query.params) : name));
		});
	}
	prepare(name) {
...
//#endregion
export { CockroachInsertBase, CockroachInsertBuilder };
