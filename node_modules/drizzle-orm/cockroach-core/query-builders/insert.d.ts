...
import { ColumnsSelection, Param, Placeholder, Query, SQL, SQLWrapper } from "../../sql/sql.js";
...
type CockroachInsertValue<TTable extends CockroachTable<TableConfig$1>, OverrideT extends boolean = false, TModel extends Record<string, any> = InferInsertModel<TTable, {
  dbColumnNames: false;
  override: OverrideT;
