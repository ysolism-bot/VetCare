...
import { CockroachSelectJoinConfig, SelectedFields, SelectedFieldsOrdered, TableLikeHasEmptySelection } from "./select.types.js";
...
type CockroachUpdateWithout<T extends AnyCockroachUpdate, TDynamic extends boolean, K extends keyof T & string> = TDynamic extends true ? T : Omit<CockroachUpdateBase<T['_']['table'], T['_']['queryResult'], T['_']['from'], T['_']['selectedFields'], T['_']['returning'], T['_']['nullabilityMap'], T['_']['joins'], TDynamic, T['_']['excludedMethods'] | K>, T['_']['excludedMethods'] | K>;
