...
//#region src/cockroach-core/query-builders/insert.ts
var CockroachInsertBuilder = class {
	static [__entity_ts.entityKind] = "CockroachInsertBuilder";
	...
	values(values) {
		...
		return new CockroachInsertBase(this.table, mappedValues, this.session, this.dialect, this.withList, false);
	}
	select(selectQuery) {
		const select = typeof selectQuery === "function" ? selectQuery(new require_cockroach_core_query_builders_query_builder.QueryBuilder()) : selectQuery;
...
var CockroachInsertBase = class extends __query_promise_ts.QueryPromise {
	static [__entity_ts.entityKind] = "CockroachInsert";
	config;
...
//#endregion
exports.CockroachInsertBase = CockroachInsertBase;
exports.CockroachInsertBuilder = CockroachInsertBuilder;
