...
//#region src/cockroach-core/columns/custom.d.ts
...
interface CockroachCustomColumnInnerConfig {
  customTypeValues: CustomTypeValues;
}
declare class CockroachCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends CockroachColumnWithArrayBuilder<T, {
...
declare class CockroachCustomColumn<T extends ColumnBaseConfig<'custom'>> extends CockroachColumn<T> {
  static readonly [entityKind]: string;
  private sqlName;
  private mapTo?;
  private mapFrom?;
  ...
  constructor(table: CockroachTable<any>, config: CockroachCustomColumnBuilder<T>['config']);
  getSQLType(): string;
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  ...
  (dbName: string, fieldConfig: T['config']): CockroachCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
...
//#endregion
export { CockroachCustomColumn, CockroachCustomColumnBuilder, CockroachCustomColumnInnerConfig, ConvertCustomConfig, CustomTypeParams, CustomTypeValues, customType };
