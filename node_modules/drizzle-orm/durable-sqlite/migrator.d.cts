...
declare function migrate<TSchema extends Record<string, unknown>, TRelations extends AnyRelations>(db: DrizzleSqliteDODatabase<TSchema, TRelations>, config: MigrationConfig$1): void | MigratorInitFailResponse;
//#endregion
export { migrate };
