...
const netlifyDbCodecs = (0, __pg_core_codecs_ts.refineGenericPgCodecs)({
	bigint: {
		normalize: BigInt,
...
const netlifyDbTransactionCodecs = (0, __pg_core_codecs_ts.refineGenericPgCodecs)({
	bigint: {
		normalize: BigInt,
		normalizeArray: (0, __pg_core_codecs_ts.arrayCompatNormalize)(BigInt)
	},
...
//#endregion
exports.netlifyDbCodecs = netlifyDbCodecs;
exports.netlifyDbTransactionCodecs = netlifyDbTransactionCodecs;
