...
var SQLiteD1Session = class extends SQLiteSession {
	...
	prepareQuery(query, fields, executeMethod, customResultMapper, queryMetadata, cacheConfig) {
		return new D1PreparedQuery(this.client.prepare(query.sql), query, this.logger, this.cache, queryMetadata, cacheConfig, fields, executeMethod, customResultMapper);
	}
	prepareRelationalQuery(query, fields, executeMethod, customResultMapper) {
		return new D1PreparedQuery(this.client.prepare(query.sql), query, this.logger, this.cache, void 0, void 0, fields, executeMethod, customResultMapper, true);
	}
	async batch(queries) {
...
var D1PreparedQuery = class extends SQLitePreparedQuery {
	...
	/** @internal */
	stmt;
	constructor(stmt, query, logger, cache, queryMetadata, cacheConfig, fields, executeMethod, customResultMapper, isRqbV2Query) {
	...
	mapAllResult(rows, isFromBatch) {
		...
		if (this.isRqbV2Query) return this.customResultMapper(rows);
	...
	mapGetResult(result, isFromBatch) {
		...
		if (this.isRqbV2Query) return this.customResultMapper([result]);
