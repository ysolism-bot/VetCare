...
declare function drizzle<TSchema extends Record<string, unknown> = Record<string, never>, TRelations extends AnyRelations = EmptyRelations, TClient extends AnyD1Database = AnyD1Database>(client: TClient, config?: Omit<DrizzleConfig<TSchema, TRelations>, 'jit'>): DrizzleD1Database<TSchema, TRelations> & {
  $client: TClient;
};
//#endregion
