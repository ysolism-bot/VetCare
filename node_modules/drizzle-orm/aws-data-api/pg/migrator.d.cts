...
declare function migrate<TRelations extends AnyRelations>(db: AwsDataApiPgDatabase<TRelations>, config: MigrationConfig): Promise<void | __migrator_ts0.MigratorInitFailResponse>;
//#endregion
export { migrate };
