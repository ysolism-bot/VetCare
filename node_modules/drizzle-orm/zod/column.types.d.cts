...
import { CoerceOptions } from "./schema.types.cjs";
...
type WrapInZodArray<TSchema extends z.ZodType, TDepth extends number> = TDepth extends 0 ? TSchema : TDepth extends 1 ? z.ZodArray<TSchema> : TDepth extends 2 ? z.ZodArray<z.ZodArray<TSchema>> : TDepth extends 3 ? z.ZodArray<z.ZodArray<z.ZodArray<TSchema>>> : TDepth extends 4 ? z.ZodArray<z.ZodArray<z.ZodArray<z.ZodArray<TSchema>>>> : TDepth extends 5 ? z.ZodArray<z.ZodArray<z.ZodArray<z.ZodArray<z.ZodArray<TSchema>>>>> : z.ZodArray<z.ZodAny>;
...
type GetZodType<TColumn extends Column<any>, TCoerce extends CoerceOptions, TType extends ColumnTypeData = ExtractColumnTypeData<TColumn['_']['dataType']>, TCanCoerce extends boolean = CanCoerce<TCoerce, ColumnTypeDataToCoerceKey<TType>>> = IsPgArrayColumn<TColumn, TType> extends true ? WrapInZodArray<GetBaseZodType<TColumn, TCoerce, TType, TCanCoerce>, GetArrayDepth<TColumn['_']['data']>> : GetBaseZodType<TColumn, TCoerce, TType, TCanCoerce>;
type GetBaseZodType<TColumn extends Column<any>, TCoerce extends CoerceOptions, TType extends ColumnTypeData = ExtractColumnTypeData<TColumn['_']['dataType']>, TCanCoerce extends boolean = CanCoerce<TCoerce, ColumnTypeDataToCoerceKey<TType>>> = TType['type'] extends 'array' ? TType['constraint'] extends 'geometry' | 'point' ? z.ZodTuple<[z.ZodNumber, z.ZodNumber], null> : TType['constraint'] extends 'line' ? z.ZodTuple<[z.ZodNumber, z.ZodNumber, z.ZodNumber], null> : TType['constraint'] extends 'vector' | 'halfvector' ? z.ZodArray<z.ZodNumber> : TType['constraint'] extends 'int64vector' ? z.ZodArray<z.ZodBigInt> : TType['constraint'] extends 'basecolumn' ? z.ZodArray<GetZodType<Assume<TColumn['_'], {
...
type HandleColumn<TType extends 'select' | 'insert' | 'update', TColumn extends Column, TCoerce extends CoerceOptions> = TType extends 'select' ? HandleSelectColumn<GetZodType<TColumn, TCoerce>, TColumn> : TType extends 'insert' ? HandleInsertColumn<GetZodType<TColumn, TCoerce>, TColumn> : TType extends 'update' ? HandleUpdateColumn<GetZodType<TColumn, TCoerce>, TColumn> : GetZodType<TColumn, TCoerce>;
//#endregion
export { GetZodType, HandleColumn };
