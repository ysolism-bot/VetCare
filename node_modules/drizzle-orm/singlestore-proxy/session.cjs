...
var SingleStoreRemoteSession = class extends __singlestore_core_session_ts.SingleStoreSession {
	...
	prepareQuery(query, fields, customResultMapper, generatedIds, returningIds) {
		return new PreparedQuery(this.client, query.sql, query.params, this.logger, fields, this.options.useJitMappers, customResultMapper, generatedIds, returningIds);
	}
	prepareRelationalQuery(query, fields, customResultMapper, config, generatedIds, returningIds) {
		return new PreparedQuery(this.client, query.sql, query.params, this.logger, fields, this.options.useJitMappers, customResultMapper, generatedIds, returningIds, true, config);
	}
	all(query) {
...
var PreparedQuery = class extends __singlestore_core_session_ts.SingleStorePreparedQuery {
	...
	jitMapper;
	constructor(client, queryString, params, logger, fields, useJitMappers, customResultMapper, generatedIds, returningIds, isRqbV2Query, rqbConfig) {
		super();
		this.client = client;
