import { nodePgCodecs } from "./codecs.js";
...
function drizzle(...params) {
	...
	return construct(typeof connection === "string" ? new pg.Pool({ connectionString: connection }) : new pg.Pool(connection), drizzlePgCDrizzlePgConfig);
}
(function(_drizzle) {
