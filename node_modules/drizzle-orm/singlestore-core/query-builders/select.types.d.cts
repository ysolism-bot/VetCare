import { SingleStoreSelectBase, SingleStoreSelectQueryBuilderBase } from "./select.cjs";
import { PreparedQueryHKTBase, PreparedQueryKind, SingleStorePreparedQueryConfig } from "../session.cjs";
...
import { SingleStoreColumn } from "../columns/index.cjs";
import { SingleStoreTable, SingleStoreTableWithColumns } from "../table.cjs";
...
type SingleStoreJoin<T extends AnySingleStoreSelectQueryBuilder, TDynamic extends boolean, TJoinType extends JoinType, TJoinedTable extends SingleStoreTable | Subquery | SQL, // | SingleStoreViewBase
