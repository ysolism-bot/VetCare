...
//#region src/singlestore-core/columns/custom.d.ts
...
interface SingleStoreCustomColumnInnerConfig {
  customTypeValues: CustomTypeValues;
}
declare class SingleStoreCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends SingleStoreColumnBuilder<T, {
...
declare class SingleStoreCustomColumn<T extends ColumnBaseConfig<'custom'>> extends SingleStoreColumn<T> {
  static readonly [entityKind]: string;
  private sqlName;
  private mapTo?;
  private mapFrom?;
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  ...
  (dbname: string, fieldConfig: T['config']): SingleStoreCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
...
//#endregion
export { ConvertCustomConfig, CustomTypeParams, CustomTypeValues, SingleStoreCustomColumn, SingleStoreCustomColumnBuilder, SingleStoreCustomColumnInnerConfig, customType };
