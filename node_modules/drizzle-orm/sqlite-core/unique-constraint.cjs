...
var UniqueConstraintBuilder = class {
	static [__entity_ts.entityKind] = "SQLiteUniqueConstraintBuilder";
	/** @internal */
	columns;
...
var UniqueOnConstraintBuilder = class {
	static [__entity_ts.entityKind] = "SQLiteUniqueOnConstraintBuilder";
	/** @internal */
	name;
	constructor(name) {
		this.name = name;
...
var UniqueConstraint = class {
	static [__entity_ts.entityKind] = "SQLiteUniqueConstraint";
	columns;
	name;
	isNameExplicit;
