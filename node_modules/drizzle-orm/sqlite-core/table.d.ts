...
declare const sqliteTable: SQLiteTableFn<undefined>;
declare function sqliteTableCreator(customizeTableName: (name: string) => string, casing?: Casing | undefined): SQLiteTableFn;
//#endregion
