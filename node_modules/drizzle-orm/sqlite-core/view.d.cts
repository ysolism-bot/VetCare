...
declare class ManualViewBuilder<TName extends string = string, TColumns extends Record<string, ColumnBuilderBase> = Record<string, ColumnBuilderBase>> extends ViewBuilderCore<{
  ...
  static readonly [entityKind]: string;
  private columns;
  constructor(name: TName, columns: TColumns, casing: Casing | undefined);
...
declare const sqliteView: SQLiteViewFn;
declare const view: SQLiteViewFn;
//#endregion
export { ManualViewBuilder, SQLiteView, SQLiteViewFn, SQLiteViewWithSelection, ViewBuilder, ViewBuilderConfig, ViewBuilderCore, sqliteView, view };
