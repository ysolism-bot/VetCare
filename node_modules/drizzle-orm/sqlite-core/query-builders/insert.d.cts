...
import { AnySQLiteColumn } from "../columns/common.cjs";
import { SelectedFieldsFlat, SelectedFieldsOrdered } from "./select.types.cjs";
import { SQLiteUpdateSetSource } from "./update.cjs";
...
import { SQLitePreparedQuery, SQLiteSession } from "../session.cjs";
...
declare class SQLiteInsertBuilder<TTable extends SQLiteTable, TResultType extends 'sync' | 'async', TRunResult> {
  ...
  constructor(table: TTable, session: SQLiteSession<any, any, any, any, any>, dialect: SQLiteDialect, withList?: Subquery[] | undefined);
...
declare class SQLiteInsertBase<TTable extends SQLiteTable, TResultType extends 'sync' | 'async', TRunResult, TReturning = undefined, TDynamic extends boolean = false, TExcludedMethods extends string = never> extends QueryPromise<TReturning extends undefined ? TRunResult : TReturning[]> implements RunnableQuery<TReturning extends undefined ? TRunResult : TReturning[], 'sqlite'>, SQLWrapper {
  ...
  private dialect;
  static readonly [entityKind]: string;
  constructor(table: TTable, values: SQLiteInsertConfig['values'], session: SQLiteSession<any, any, any, any, any>, dialect: SQLiteDialect, withList?: Subquery[], select?: boolean);
  /**
...
//#endregion
export { AnySQLiteInsert, SQLiteInsert, SQLiteInsertBase, SQLiteInsertBuilder, SQLiteInsertConfig, SQLiteInsertDynamic, SQLiteInsertExecute, SQLiteInsertOnConflictDoUpdateConfig, SQLiteInsertPrepare, SQLiteInsertReturning, SQLiteInsertReturningAll, SQLiteInsertSelectQueryBuilder, SQLiteInsertValue, SQLiteInsertWithout };
