...
var SQLiteRelationalQuery = class extends __query_promise_ts.QueryPromise {
	...
	_prepare(isOneTimeQuery = true) {
		...
		return this.session[isOneTimeQuery ? "prepareOneTimeRelationalQuery" : "prepareRelationalQuery"](builtQuery, void 0, this.mode === "first" ? "get" : "all", (0, __relations_ts.makeDefaultRqbMapper)({
