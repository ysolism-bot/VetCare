...
var MsSqlSelectFromBuilderBase = class {
	static [__entity_ts.entityKind] = "MsSqlSelectFromBuilderBase";
	fields;
	session;
	dialect;
	withList = [];
	...
	from(source) {
		...
		else if ((0, __entity_ts.is)(source, require_mssql_core_view_base.MsSqlViewBase)) fields = source[__view_common_ts.ViewBaseConfig].selectedFields;
...
var MsSqlSelectQueryBuilderBase = class extends __query_builders_query_builder_ts.TypedQueryBuilder {
	static [__entity_ts.entityKind] = "MsSqlSelectQueryBuilderBase";
	_;
	config;
	joinsNotNullableMap;
	tableName;
...
var MsSqlSelectBase = class extends MsSqlSelectQueryBuilderBase {
	static [__entity_ts.entityKind] = "MsSqlSelect";
	prepare() {
...
(0, __utils_ts.applyMixins)(MsSqlSelectBase, [__query_promise_ts.QueryPromise]);
...
//#endregion
exports.MsSqlSelectBase = MsSqlSelectBase;
exports.MsSqlSelectBuilder = MsSqlSelectBuilder;
exports.MsSqlSelectQueryBuilderBase = MsSqlSelectQueryBuilderBase;
