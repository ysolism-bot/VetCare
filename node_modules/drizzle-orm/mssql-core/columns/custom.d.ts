...
import { ColumnBuilderBaseConfig } from "../../index.js";

//#region src/mssql-core/columns/custom.d.ts
...
interface MsSqlCustomColumnInnerConfig {
  customTypeValues: CustomTypeValues;
}
declare class MsSqlCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends MsSqlColumnBuilder<T, {
...
declare class MsSqlCustomColumn<T extends ColumnBaseConfig<'custom'>> extends MsSqlColumn<T> {
  static readonly [entityKind]: string;
  private sqlName;
  private mapTo?;
  private mapFrom?;
  ...
  constructor(table: MsSqlTable<any>, config: MsSqlCustomColumnBuilder<T>['config']);
  getSQLType(): string;
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  <TConfig extends Record<string, any> & T['config']>(fieldConfig: TConfig): MsSqlCustomColumnBuilder<ConvertCustomConfig<T>>;
  (dbName: string, fieldConfig: T['config']): MsSqlCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
...
//#endregion
export { ConvertCustomConfig, CustomTypeParams, CustomTypeValues, MsSqlCustomColumn, MsSqlCustomColumnBuilder, MsSqlCustomColumnInnerConfig, customType };
