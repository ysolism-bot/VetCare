 ...
 */
declare function migrate<TRelations extends AnyRelations = EmptyRelations>(db: XataHttpDatabase<TRelations>, config: MigrationConfig): Promise<void | MigratorInitFailResponse>;
//#endregion
