...
declare class NodeCockroachTransaction<TFullSchema extends Record<string, unknown>, TSchema extends V1.TablesRelationalConfig> extends CockroachTransaction<NodeCockroachQueryResultHKT, TFullSchema, TSchema> {
  static readonly [entityKind]: string;
