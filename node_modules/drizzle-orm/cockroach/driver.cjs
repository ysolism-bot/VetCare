...
var NodeCockroachDriver = class {
	...
	createSession(schema) {
		return new require_cockroach_session.NodeCockroachSession(this.client, this.dialect, schema, {
...
function construct(client, config = {}) {
	const dialect = new __cockroach_core_dialect_ts.CockroachDialect();
	let logger;
