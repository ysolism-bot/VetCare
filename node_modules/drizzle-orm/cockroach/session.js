	...
	async execute(placeholderValues = {}) {
		return tracer.startActiveSpan("drizzle.execute", async () => {
			...
			return tracer.startActiveSpan("drizzle.mapResponse", () => {
				...
				return this.useJitMappers ? (this.jitMapper ??= makeJitQueryMapper(fields, joinsNotNullableMap))(result.rows) : result.rows.map((row) => mapResultRow(fields, row, joinsNotNullableMap));
			});
		});
	}
