...
import { AnyMySqlTable } from "../table.cjs";

//#region src/mysql-core/columns/custom.d.ts
...
declare class MySqlCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends MySqlColumnBuilder<T, {
...
declare class MySqlCustomColumn<T extends ColumnBaseConfig<'custom'>> extends MySqlColumn<T> {
  static readonly [entityKind]: string;
  private sqlName;
  private mapTo?;
  private mapFrom?;
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  ...
  (dbName: string, fieldConfig: T['config']): MySqlCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
  <TConfig extends Record<string, any> & T['config']>(fieldConfig?: TConfig): MySqlCustomColumnBuilder<ConvertCustomConfig<T>>;
  (dbName: string, fieldConfig?: T['config']): MySqlCustomColumnBuilder<ConvertCustomConfig<T>>;
};
//#endregion
export { ConvertCustomConfig, CustomTypeParams, CustomTypeValues, MySqlCustomColumn, MySqlCustomColumnBuilder, MySqlCustomColumnInnerConfig, customType };
