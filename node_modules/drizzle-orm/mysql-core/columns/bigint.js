...
var MySqlBigIntString = class extends MySqlColumnWithAutoIncrement {
	static [entityKind] = "MySqlBigIntString";
	getSQLType() {
		return `bigint${this.config.unsigned ? " unsigned" : ""}`;
	}
	mapFromDriverValue = (value) => {
...
//#endregion
export { MySqlBigInt53, MySqlBigInt53Builder, MySqlBigInt64, MySqlBigInt64Builder, MySqlBigIntString, MySqlBigIntStringBuilder, bigint };
