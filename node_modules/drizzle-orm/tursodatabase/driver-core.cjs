...
var TursoDatabaseDatabase = class extends __sqlite_core_db_ts.BaseSQLiteDatabase {
	static [__entity_ts.entityKind] = "TursoDatabaseDatabase";
};
/** @internal */
function construct(client, config = {}) {
	const dialect = new __sqlite_core_dialect_ts.SQLiteAsyncDialect();
	let logger;
	...
	const db = new TursoDatabaseDatabase("async", dialect, new require_tursodatabase_session.TursoDatabaseSession(client, dialect, relations, schema, {
		logger,
		cache: config.cache,
