import { PgSelectJoinConfig, SelectedFields, SelectedFieldsOrdered, TableLikeHasEmptySelection } from "./select.types.js";
import { PgColumn } from "../columns/common.js";
import { PgViewBase } from "../view-base.js";
import { entityKind } from "../../entity.js";
import { Subquery } from "../../subquery.js";
import { InferInsertModel, Table } from "../../table.js";
import { GetColumnData } from "../../column.js";
import { Assume, DrizzleTypeError, Equal, Simplify, UpdateSet } from "../../utils.js";
...
type PgUpdateWithout<T extends AnyPgUpdate, TDynamic extends boolean, K extends keyof T & string> = TDynamic extends true ? T : Omit<PgUpdateKind<T['_']['hkt'], T['_']['table'], T['_']['queryResult'], T['_']['from'], T['_']['selectedFields'], T['_']['returning'], T['_']['nullabilityMap'], T['_']['joins'], TDynamic, T['_']['excludedMethods'] | K>, T['_']['excludedMethods'] | K>;
