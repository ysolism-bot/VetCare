...
let __pg_core_dialect_ts = require("../dialect.cjs");
let __selection_proxy_ts = require("../../selection-proxy.cjs");

//#region src/pg-core/query-builders/query-builder.ts
var QueryBuilder = class {
	static [__entity_ts.entityKind] = "PgQueryBuilder";
	dialect;
	dialectConfig;
	constructor(dialect) {
		this.dialect = (0, __entity_ts.is)(dialect, __pg_core_dialect_ts.PgDialect) ? dialect : void 0;
		this.dialectConfig = (0, __entity_ts.is)(dialect, __pg_core_dialect_ts.PgDialect) ? void 0 : dialect;
	}
	...
	with(...queries) {
		...
		function select(fields) {
			return new require_pg_core_query_builders_select.PgSelectBuilder({
	...
	getDialect() {
		if (!this.dialect) this.dialect = new __pg_core_dialect_ts.PgDialect(this.dialectConfig);
		return this.dialect;
	}
};
