...
import { AnyPgColumn } from "../columns/common.js";
import { QueryBuilder } from "./query-builder.js";
import { PgUpdateSetSource } from "./update.js";
import { entityKind } from "../../entity.js";
import { Subquery } from "../../subquery.js";
import { InferInsertModel } from "../../table.js";
import { Assume } from "../../utils.js";
import { ColumnsSelection, Param, Placeholder, Query, SQL, SQLWrapper, SqlCommenterInput } from "../../sql/sql.js";
import { PgDialect } from "../dialect.js";
import { TypedQueryBuilder } from "../../query-builders/query-builder.js";
import { PgTable, TableConfig as TableConfig$1 } from "../table.js";
...
type PgInsertWithout<T extends AnyPgInsert, TDynamic extends boolean, K extends string> = TDynamic extends true ? T : Omit<PgInsertKind<T['_']['hkt'], T['_']['table'], T['_']['queryResult'], T['_']['selectedFields'], T['_']['returning'], TDynamic, T['_']['excludedMethods'] | K>, T['_']['excludedMethods'] | K>;
