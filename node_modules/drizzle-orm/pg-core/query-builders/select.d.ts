...
interface PgSelectBuilderConstructor {
  new (config: {
...
declare class PgSelectBuilder<TSelection extends SelectedFields | undefined, THKT extends PgSelectHKTBase = PgSelectQueryBuilderHKT> {
  private builder;
  ...
  constructor(config: {
    ...
    tagged?: boolean;
  }, builder?: PgSelectBuilderConstructor);
  /**
  ...
  }>(source: TableLikeHasEmptySelection<TFrom> extends true ? DrizzleTypeError<"Cannot reference a data-modifying statement subquery if it doesn't contain a `returning` clause"> : TFrom): PgSelectKind<THKT, TConfig['tableName'], TConfig['selection'], TConfig['selectMode'], TConfig['tableName'] extends string ? Record<TConfig['tableName'], 'not-null'> : {}, false, never>;
}
...
//#endregion
export { PgSelect, PgSelectBase, PgSelectBuilder, PgSelectBuilderConstructor, PgSelectQueryBuilder, except, exceptAll, intersect, intersectAll, union, unionAll };
