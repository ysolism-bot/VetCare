import { ExtraConfigColumn, IndexedColumn, PgColumn } from "./columns/common.cjs";
import { PgTable } from "./table.cjs";
import { entityKind } from "../entity.cjs";
import { SQL } from "../sql/sql.cjs";

//#region src/pg-core/indexes.d.ts
...
declare class IndexBuilderOn {
  ...
  on(...columns: [Partial<ExtraConfigColumn> | SQL | PgColumn, ...(Partial<ExtraConfigColumn | SQL | PgColumn>)[]]): IndexBuilder;
  onOnly(...columns: [Partial<ExtraConfigColumn | SQL | PgColumn>, ...Partial<ExtraConfigColumn | SQL | PgColumn>[]]): IndexBuilder;
  /**
   ...
   * @returns
   */
  using(method: PgIndexMethod, ...columns: [Partial<ExtraConfigColumn | SQL | PgColumn>, ...Partial<ExtraConfigColumn | SQL | PgColumn>[]]): IndexBuilder;
}
...
type GetColumnsTableName<TColumns> = TColumns extends PgColumn ? TColumns['_']['name'] : TColumns extends PgColumn[] ? TColumns[number]['_']['name'] : never;
declare function index(name?: string): IndexBuilderOn;
declare function uniqueIndex(name?: string): IndexBuilderOn;
//#endregion
export { AnyIndexBuilder, GetColumnsTableName, Index, IndexBuilder, IndexBuilderOn, IndexColumn, PgIndexMethod, PgIndexOpClass, index, uniqueIndex };
