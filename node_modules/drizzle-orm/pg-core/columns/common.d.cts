import { PgIndexOpClass } from "../indexes.cjs";
import { entityKind } from "../../entity.cjs";
import { SQL } from "../../sql/sql.cjs";
import { Update } from "../../utils.cjs";
import { Column } from "../../column.cjs";
import { ColumnType, GeneratedColumnConfig, GeneratedIdentityConfig } from "../../column-builder.cjs";
...
declare class IndexedColumn {
  static readonly [entityKind]: string;
  constructor(name: string, keyAsName: boolean, type: string, indexConfig: IndexedExtraConfigType);
  name: string;
  keyAsName: boolean;
  type: string;
  indexConfig: IndexedExtraConfigType;
