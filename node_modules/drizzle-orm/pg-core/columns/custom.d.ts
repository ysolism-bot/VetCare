import { PostgresColumnType } from "../codecs.js";
...
//#region src/pg-core/columns/custom.d.ts
...
declare class PgCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends PgColumnBuilder<T, {
...
declare function customType<T extends CustomTypeValues = CustomTypeValues>(customTypeParams: CustomTypeParams<T>): Equal<T['configRequired'], true> extends true ? {
  ...
  (dbName: string, fieldConfig: T['config']): PgCustomColumnBuilder<ConvertCustomConfig<T>>;
} : {
  <TConfig extends Record<string, any> & T['config']>(fieldConfig?: TConfig): PgCustomColumnBuilder<ConvertCustomConfig<T>>;
  (dbName: string, fieldConfig?: T['config']): PgCustomColumnBuilder<ConvertCustomConfig<T>>;
};
//#endregion
export { ConvertCustomConfig, CustomTypeParams, CustomTypeValues, PgCustomColumn, PgCustomColumnBuilder, PgCustomColumnInnerConfig, customType };
