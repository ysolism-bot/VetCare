...
export interface paths {
  ...
  "/accounts/{account_id}/ai-gateway/token": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/aiGateway/operation/getAccountAIGatewayToken | `getAccountAIGatewayToken`}
     *
     * Returns an AI Gateway token scoped to an account
     */
    get: operations["getAccountAIGatewayToken"];
    parameters: {
      path: {
        /** The account ID */
        account_id: string;
  ...
  "/sites/{site_id}/database": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/getSiteDatabase | `getSiteDatabase`}
     *
     * Returns the database connection string for the specified site.
     */
    get: operations["getSiteDatabase"];
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/createSiteDatabase | `createSiteDatabase`}
     *
     ...
     */
    post: operations["createSiteDatabase"];
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/deleteSiteDatabase | `deleteSiteDatabase`}
     *
     * Deletes the database and all associated branches and snapshots for the specified site.
     */
    delete: operations["deleteSiteDatabase"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/branch": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/createSiteDatabaseBranch | `createSiteDatabaseBranch`}
     *
     ...
     */
    post: operations["createSiteDatabaseBranch"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/branches": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/listSiteDatabaseBranches | `listSiteDatabaseBranches`}
     *
     * Returns all branches for the site's database with compute status and metadata.
     */
    get: operations["listSiteDatabaseBranches"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/branch/{branch_id}": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/getSiteDatabaseBranch | `getSiteDatabaseBranch`}
     *
     * Returns the database branch connection string for a specific branch.
     */
    get: operations["getSiteDatabaseBranch"];
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/deleteSiteDatabaseBranch | `deleteSiteDatabaseBranch`}
     *
     * Deletes a database branch.
     */
    delete: operations["deleteSiteDatabaseBranch"];
    parameters: {
      path: {
        site_id: string;
        /** The branch ID */
  ...
  "/sites/{site_id}/database/branch/{branch_id}/reset": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/resetSiteDatabaseBranch | `resetSiteDatabaseBranch`}
     *
     ...
     */
    post: operations["resetSiteDatabaseBranch"];
    parameters: {
      path: {
        site_id: string;
  ...
  "/sites/{site_id}/database/branch/{branch_id}/compute/settings": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/setSiteDatabaseBranchComputeSettings | `setSiteDatabaseBranchComputeSettings`}
     *
     * Sets compute settings for a specific database branch, overriding project-level settings. Requires a Pro or higher plan.
     */
    put: operations["setSiteDatabaseBranchComputeSettings"];
    parameters: {
      path: {
        site_id: string;
        /** The branch ID */
  ...
  "/sites/{site_id}/database/compute/settings": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/getSiteDatabaseComputeSettings | `getSiteDatabaseComputeSettings`}
     *
     ...
     */
    get: operations["getSiteDatabaseComputeSettings"];
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/setSiteDatabaseComputeSettings | `setSiteDatabaseComputeSettings`}
     *
     ...
     */
    put: operations["setSiteDatabaseComputeSettings"];
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/clearSiteDatabaseComputeSettings | `clearSiteDatabaseComputeSettings`}
     *
     * Resets project-level compute settings to tier defaults. Requires a Pro or higher plan.
     */
    delete: operations["clearSiteDatabaseComputeSettings"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/migrations": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/listSiteDatabaseMigrations | `listSiteDatabaseMigrations`}
     *
     ...
     */
    get: operations["listSiteDatabaseMigrations"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/migrations/{name}": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/getSiteDatabaseMigration | `getSiteDatabaseMigration`}
     *
     * Returns the contents of a named migration for the specified branch.
     */
    get: operations["getSiteDatabaseMigration"];
    parameters: {
      path: {
        site_id: string;
        /** The migration name */
  ...
  "/sites/{site_id}/database/migrations/{deploy_id}": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/runSiteDatabaseMigrations | `runSiteDatabaseMigrations`}
     *
     * Runs database migrations for the specified deploy. Finds the deploy and determines the appropriate branch.
     */
    post: operations["runSiteDatabaseMigrations"];
    parameters: {
      path: {
        site_id: string;
  ...
  "/sites/{site_id}/database/snapshot": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/createSiteDatabaseSnapshot | `createSiteDatabaseSnapshot`}
     *
     * Creates a point-in-time snapshot of a database branch. Defaults to the production branch if no branch name is specified.
     */
    post: operations["createSiteDatabaseSnapshot"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/snapshots": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/listSiteDatabaseSnapshots | `listSiteDatabaseSnapshots`}
     *
     * Returns all snapshots for the site's database.
     */
    get: operations["listSiteDatabaseSnapshots"];
    parameters: {
      path: {
        site_id: string;
      };
  ...
  "/sites/{site_id}/database/snapshot/{snapshot_id}": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/deleteSiteDatabaseSnapshot | `deleteSiteDatabaseSnapshot`}
     *
     * Deletes a database snapshot.
     */
    delete: operations["deleteSiteDatabaseSnapshot"];
    parameters: {
      path: {
        site_id: string;
        /** The snapshot ID */
  ...
  "/sites/{site_id}/database/snapshot/{snapshot_id}/restore": {
    /**
     * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/restoreSiteDatabaseSnapshot | `restoreSiteDatabaseSnapshot`}
     *
     * Restores a snapshot to a database branch. Defaults to the production branch if no branch_name is specified.
     */
    post: operations["restoreSiteDatabaseSnapshot"];
    parameters: {
      path: {
        site_id: string;
...
export interface components {
  schemas: {
    ...
    databaseBranchesResponse: {
      ...
      branches?: components["schemas"]["databaseBranchDetail"][];
    };
    ...
    databaseBranchDetail: {
       ...
       * @enum {string}
       */
      state?: "init" | "creating" | "resetting" | "ready" | "archived";
      /**
       * Format: int64
      ...
      compute?: components["schemas"]["databaseBranchCompute"];
      /** @description Metadata associated with the branch */
      metadata?: { [key: string]: unknown };
    };
    ...
    createDatabaseSnapshotRequest: {
      ...
      name?: string;
      metadata?: components["schemas"]["databaseSnapshotMetadata"];
    };
    ...
    databaseComputeSettingsRequest: {
       ...
       */
      sleep_timeout_seconds?: number | null;
    };
    ...
    listDatabaseMigrationsResponse: {
      ...
      migrations?: components["schemas"]["databaseMigration"][];
    };
  ...
  requestBodies: {
    ...
    databaseComputeSettingsRequest: {
      content: {
        "application/json": components["schemas"]["databaseComputeSettingsRequest"];
      };
    };
  };
}
...
export interface operations {
  ...
  listSiteDatabaseBranches: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["databaseBranchesResponse"];
        };
      };
      default: components["responses"]["error"];
    };
  ...
  resetSiteDatabaseBranch: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["resetDatabaseBranchResponse"];
        };
      };
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["resetDatabaseBranchRequest"];
      };
    };
  };
  /**
  ...
  setSiteDatabaseBranchComputeSettings: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["databaseComputeSettings"];
        };
      };
    ...
    requestBody: components["requestBodies"]["databaseComputeSettingsRequest"];
  };
  /**
   * API Reference: {@link https://open-api.netlify.com/#tag/database/operation/getSiteDatabaseComputeSettings | `getSiteDatabaseComputeSettings`}
   *
  ...
  listSiteDatabaseMigrations: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["listDatabaseMigrationsResponse"];
        };
      };
      /** Database or branch not found */
      404: unknown;
  ...
  getSiteDatabaseMigration: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["databaseMigrationDetail"];
        };
      };
  ...
  runSiteDatabaseMigrations: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["runDatabaseMigrationsRequest"];
      };
    };
  };
  /**
  ...
  createSiteDatabaseSnapshot: {
    ...
    responses: {
      ...
      201: {
        content: {
          "application/json": components["schemas"]["databaseSnapshot"];
        };
      };
      default: components["responses"]["error"];
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["createDatabaseSnapshotRequest"];
      };
    };
  };
  /**
  ...
  listSiteDatabaseSnapshots: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["databaseSnapshotsResponse"];
        };
      };
      default: components["responses"]["error"];
    };
  ...
  restoreSiteDatabaseSnapshot: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["restoreDatabaseSnapshotRequest"];
      };
    };
  };
}
