...
const require_dist_cjs$36 = require('./dist-cjs-UWi57ZSc.js');
...
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const remoteProvider = async (init) => {
		const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-Cj1M6Wnw.js").default));
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromIni } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-DP1dfP1V.js").default));
			return fromIni(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
			const { fromProcess } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-DUq-vErp.js").default));
			return fromProcess(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
			const { fromTokenFile } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-CR89m5U6.js").default));
