...
const require_dist_cjs$36 = require('./dist-cjs-wRND57ru.js');
const require_dist_cjs$37 = require('./dist-cjs-C1V3hN4z.js');
const require_dist_cjs$38 = require('./dist-cjs-DJqjr70i.js');
const require_dist_cjs$39 = require('./dist-cjs-Dp8oIgKa.js');
const require_dist_cjs$40 = require('./dist-cjs-B3VivlS8.js');
const require_client = require('./client-VFkjMFq-.js');
const require_dist_cjs$41 = require('./dist-cjs-ZJzjWKq4.js');
const require_dist_cjs$42 = require('./dist-cjs-Cev9lui1.js');
	...
	ProtocolLib = class {
		...
		setQueryCompatError(output, response) {
			...
			if (output !== void 0 && queryErrorHeader != null) {
				...
				for (const [k, v] of entries) Error[k] = v;
				delete Error.__type;
				output.Error = Error;
			}
		}
...
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const inferPhysicalRegion = async () => {
		...
		if (!process.env[ENV_IMDS_DISABLED]) try {
			const { getInstanceMetadataEndpoint, httpRequest } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-Cj1M6Wnw.js").default));
