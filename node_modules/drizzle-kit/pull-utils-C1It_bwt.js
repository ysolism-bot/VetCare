...
var pull_utils_exports = /* @__PURE__ */ require_chunk.__exportAll({ prepareEntityFilter: () => prepareEntityFilter });
const prepareEntityFilter = (dialect, params, existingEntities) => {
	...
	for (const ext of params.extensions ?? []) if (ext === "postgis") tablesConfig.push(...postgisTablesGlobs);
	else require_utils.assertUnreachable(ext);
...
//#endregion
Object.defineProperty(exports, 'pull_utils_exports', {
  enumerable: true,
  get: function () {
    return pull_utils_exports;
  }
});