...
const require_dist_cjs$29 = require('./dist-cjs-C1V3hN4z.js');
const require_dist_cjs$30 = require('./dist-cjs-BCV30_Cj.js');
const require_dist_cjs$31 = require('./dist-cjs-DJqjr70i.js');
const require_dist_cjs$32 = require('./dist-cjs-Dp8oIgKa.js');
const require_dist_cjs$33 = require('./dist-cjs-B3VivlS8.js');
const require_client = require('./client-VFkjMFq-.js');
const require_dist_cjs$34 = require('./dist-cjs-ZJzjWKq4.js');
const require_dist_cjs$35 = require('./dist-cjs-Cev9lui1.js');

//#region ../node_modules/.pnpm/@aws-sdk+token-providers@3.940.0/node_modules/@aws-sdk/token-providers/dist-cjs/index.js
var require_dist_cjs$2 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var httpAuthSchemes = (require_dist_cjs$30.init_httpAuthSchemes(), require_chunk.__toCommonJS(require_dist_cjs$30.httpAuthSchemes_exports));
	...
	const getSsoOidcClient = async (ssoRegion, init = {}) => {
		const { SSOOIDCClient } = await Promise.resolve().then(() => require("./sso-oidc-vgpv2Xio.js"));
	...
	const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
		const { CreateTokenCommand } = await Promise.resolve().then(() => require("./sso-oidc-vgpv2Xio.js"));
		return (await getSsoOidcClient(ssoRegion, init)).send(new CreateTokenCommand({
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/auth/httpAuthSchemeProvider.js
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/package.json
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/endpoint/ruleset.js
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/endpoint/endpointResolver.js
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/runtimeConfig.shared.js
var require_runtimeConfig_shared = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const core_2 = (require_dist_cjs$30.init_dist_es$1(), require_chunk.__toCommonJS(require_dist_cjs$30.dist_es_exports$1));
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/runtimeConfig.js
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+client-sso@3.940.0/node_modules/@aws-sdk/client-sso/dist-cjs/index.js
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.940.0/node_modules/@aws-sdk/credential-provider-sso/dist-cjs/loadSso-CVy8iqsZ.js
var require_loadSso_CVy8iqsZ = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	var clientSso = require_dist_cjs$1();
...
//#endregion
//#region ../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.940.0/node_modules/@aws-sdk/credential-provider-sso/dist-cjs/index.js
var require_dist_cjs = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	var propertyProvider = require_dist_cjs$34.require_dist_cjs();
	var sharedIniFileLoader = require_dist_cjs$35.require_dist_cjs();
	var client = (require_client.init_client(), require_chunk.__toCommonJS(require_client.client_exports));
	var tokenProviders = require_dist_cjs$2();
