...
const require_dist_cjs$5 = require('./dist-cjs-C1V3hN4z.js');
const require_client = require('./client-VFkjMFq-.js');
const require_dist_cjs$6 = require('./dist-cjs-ZJzjWKq4.js');
const require_dist_cjs$7 = require('./dist-cjs-Cev9lui1.js');
...
var { toStringTag: t, iterator: i, hasInstance: h } = Symbol, r = Math.random, m = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), f = (a, b, c) => (a += "", /^(Blob|File)$/.test(b && b[t]) ? [(c = c !== void 0 ? c + "" : b[t] == "File" ? b.name : "blob", a), b.name !== c || b[t] == "blob" ? new File([b], c, b) : b] : [a, b + ""]), e = (c, f) => (f ? c : c.replace(/\r?\n|\r/g, "\r\n")).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), x = (n, a, e) => {
...
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./signin-Buh2ql0x.js"));
...
var require_dist_cjs = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				const { fromHttp } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-D3MlFP7Q.js").default));
				const { fromContainerMetadata } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-Cj1M6Wnw.js").default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-Cj1M6Wnw.js").default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await Promise.resolve().then(() => require("./dist-cjs-UWi57ZSc.js")).then((n) => /* @__PURE__ */ require_chunk.__toESM(n.require_dist_cjs()));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./sts-T1y5K8UP.js")).then((n) => (n.init_sts(), n.sts_exports));
	...
	const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-DUq-vErp.js").default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveSsoCredentials = async (profile, profileData, options = {}) => {
		const { fromSSO } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-to2v3P5b.js").default));
		return fromSSO({
			profile,
			logger: options.logger,
	...
	const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-CR89m5U6.js").default)).then(({ fromTokenFile }) => fromTokenFile({
